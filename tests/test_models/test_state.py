#!/usr/bin/python3
"""models/state.py unittests definiton.

Classes of unittest:
 TestState_instantation
 TestState_save
 TestState_to_dict
"""
import os
...
class TestState_instantiation(unittest.TestCase):
    """Unittest to check on instantation of the State class."""
...
class TestState_save(unittest.TestCase):
    """Unittest to check the save method of State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unittest to check to_dict method of the State class."""
