#!/usr/bin/python3
"""Definition of models/city.py Unittest.
...
class TestCity_instantiation(unittest.TestCase):
    """City class instantiation unittest test."""
...
class TestCity_save(unittest.TestCase):
    """City class save method test unittests ."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests of the City class to_dict method test."""
