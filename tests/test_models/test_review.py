...
class TestReview_instantiation(unittest.TestCase):
    """Unittests to check the Review class instantation."""
...
class TestReview_save(unittest.TestCase):
    """Unittests to check the save method of Review class."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittest to check to_dict method of the Review class."""
