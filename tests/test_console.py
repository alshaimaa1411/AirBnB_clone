...
class TestHBNBCommand_prompting(unittest.TestCase):
    """command interpreter prompting test."""
...
class TestHBNBCommand_help(unittest.TestCase):
    """command interpreter help message test."""
    ...
    def test_help_create(self):
        h = "Instance creation of Model given its name eg.\n        "
        h += "$ create ModelName\n        "
        h += "Displays an Error if ModelName is missing or dont exist"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_EOF(self):
        h = "Quit the program in non-interactive mode"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_show(self):
        h = "Instance show of Model base on its ModelName and id eg.\n"
        h += "        $ show MyModel instance_id\n        "
        h += "Display error message if either MyModel or "
        h += "instance_id is missing\n        "
        h += "Display error message for wrong MyModel or instance_id"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help show"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_destroy(self):
        h = ("Instance deletion of Model base on its Name and id.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_update(self):
        h = "Instance base update on its id eg"
        h += "\n        $ update Model id field value"
        h += "\n        Display errors for missied arguments"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help update"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help(self):
        h = ("EOF  create  all destroy  help  models  quit  show  update")
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    """command interpreter new creation test."""
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """command interpreter destroy action test."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """command interpreter update test."""
...
class TestHBNBCommand_count(unittest.TestCase):
    """command interpreter count method test."""
